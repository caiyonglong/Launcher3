...
public class WidgetsBottomSheet extends AbstractFloatingView implements Insettable, TouchController,
    ...
    public WidgetsBottomSheet(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mGradientBackground = (GradientView) mLauncher.getLayoutInflater().inflate(
                com.android.launcher3.R.layout.gradient_bg, mLauncher.getDragLayer(), false);
    }
    ...
    public void populateAndShow(ItemInfo itemInfo) {
        ...
        ((TextView) findViewById(com.android.launcher3.R.id.title)).setText(getContext().getString(
                com.android.launcher3.R.string.widgets_bottom_sheet_title, mOriginalItemInfo.title));
    ...
    protected void onWidgetsBound() {
        ...
        ViewGroup widgetRow = (ViewGroup) findViewById(com.android.launcher3.R.id.widgets);
        ViewGroup widgetCells = (ViewGroup) widgetRow.findViewById(com.android.launcher3.R.id.widgets_cell_list);
        ...
        if (widgets.size() == 1) {
            ...
            View leftPaddingView = LayoutInflater.from(getContext()).inflate(
                    com.android.launcher3.R.layout.widget_list_divider, widgetRow, false);
    ...
    private void addDivider(ViewGroup parent) {
        LayoutInflater.from(getContext()).inflate(com.android.launcher3.R.layout.widget_list_divider, parent, true);
    }

    private WidgetCell addItemCell(ViewGroup parent) {
        WidgetCell widget = (WidgetCell) LayoutInflater.from(getContext()).inflate(
                com.android.launcher3.R.layout.widget_cell, parent, false);
    ...
    private void open(boolean animate) {
        ...
        mIsOpen = true;
        boolean isSheetDark = Themes.getAttrBoolean(mLauncher, com.android.launcher3.R.attr.isMainColorDark);
