...
public class WidgetsListAdapter extends Adapter<WidgetsRowViewHolder> {
    ...
    public WidgetsListAdapter(Context context, LayoutInflater layoutInflater,
        ...
        mIndent = context.getResources().getDimensionPixelSize(com.android.launcher3.R.dimen.widget_section_indent);
        ...
        if (expectedChildCount > childCount) {
            for (int i = childCount ; i < expectedChildCount; i++) {
                if ((i & 1) == 1) {
                    ...
                    mLayoutInflater.inflate(com.android.launcher3.R.layout.widget_list_divider, row);
                } else {
                    // Add cell for even index
                    WidgetCell widget = (WidgetCell) mLayoutInflater.inflate(
                            com.android.launcher3.R.layout.widget_cell, row, false);
    ...
    public WidgetsRowViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewGroup container = (ViewGroup) mLayoutInflater.inflate(
                com.android.launcher3.R.layout.widgets_list_row_view, parent, false);

        // if the end padding is 0, then container view (horizontal scroll view) doesn't respect
        // the end of the linear layout width + the start padding and doesn't allow scrolling.
        container.findViewById(com.android.launcher3.R.id.widgets_cell_list).setPaddingRelative(mIndent, 0, 1, 0);
