...
public class NotificationFooterLayout extends FrameLayout {
    ...
    public NotificationFooterLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int iconSize = res.getDimensionPixelSize(com.android.launcher3.R.dimen.notification_footer_icon_size);
        ...
        int paddingEnd = res.getDimensionPixelSize(com.android.launcher3.R.dimen.notification_footer_icon_row_padding);
        int ellipsisSpace = res.getDimensionPixelSize(com.android.launcher3.R.dimen.horizontal_ellipsis_offset)
                + res.getDimensionPixelSize(com.android.launcher3.R.dimen.horizontal_ellipsis_size);
        int footerWidth = res.getDimensionPixelSize(com.android.launcher3.R.dimen.bg_popup_item_width);
    ...
    protected void onFinishInflate() {
        ...
        mOverflowEllipsis = findViewById(com.android.launcher3.R.id.overflow);
        mIconRow = (LinearLayout) findViewById(com.android.launcher3.R.id.icon_row);
        ...
        if (mIconRow.getChildCount() == 0) {
            ...
            if (popup != null) {
                ...
                Animator collapseFooter = popup.reduceNotificationViewHeight(getHeight() - newHeight,
                        getResources().getInteger(com.android.launcher3.R.integer.config_removeNotificationViewDuration));
                collapseFooter.addListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        ((ViewGroup) getParent()).findViewById(com.android.launcher3.R.id.divider).setVisibility(GONE);
