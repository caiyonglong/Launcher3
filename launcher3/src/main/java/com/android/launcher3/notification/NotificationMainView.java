...
public class NotificationMainView extends FrameLayout implements SwipeDetector.Listener {
    ...
    protected void onFinishInflate() {
        ...
        mTextAndBackground = (ViewGroup) findViewById(com.android.launcher3.R.id.text_and_background);
        ...
        mTitleView = (TextView) mTextAndBackground.findViewById(com.android.launcher3.R.id.title);
        mTextView = (TextView) mTextAndBackground.findViewById(com.android.launcher3.R.id.text);
    }
