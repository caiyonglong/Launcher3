...
public class NotificationItemView extends PopupItemView implements UserEventDispatcher.LogContainerProvider {
    ...
    protected void onFinishInflate() {
        ...
        mHeaderText = findViewById(com.android.launcher3.R.id.notification_text);
        mHeaderCount = findViewById(com.android.launcher3.R.id.notification_count);
        mMainView = findViewById(com.android.launcher3.R.id.main_view);
        mFooter = findViewById(com.android.launcher3.R.id.footer);
    ...
    public Animator animateHeightRemoval(int heightToRemove, boolean shouldRemoveFromTop) {
        ...
        View bottomGutter = findViewById(com.android.launcher3.R.id.gutter_bottom);
            ...
            if (mNotificationHeaderTextColor == Notification.COLOR_DEFAULT) {
                mNotificationHeaderTextColor =
                        IconPalette.resolveContrastColor(getContext(), palette.dominantColor,
                                Themes.getAttrColor(getContext(), com.android.launcher3.R.attr.popupColorPrimary));
            }
