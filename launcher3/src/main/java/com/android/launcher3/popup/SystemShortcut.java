...
public abstract class SystemShortcut extends ItemInfo {
    ...
    public static class Widgets extends SystemShortcut {
        ...
        public Widgets() {
            super(com.android.launcher3.R.drawable.ic_widget, com.android.launcher3.R.string.widget_button_text);
        }
                ...
                public void onClick(View view) {
                    ...
                    WidgetsBottomSheet widgetsBottomSheet =
                            (WidgetsBottomSheet) launcher.getLayoutInflater().inflate(
                                    com.android.launcher3.R.layout.widgets_bottom_sheet, launcher.getDragLayer(), false);
    ...
    public static class AppInfo extends SystemShortcut {
        public AppInfo() {
            super(com.android.launcher3.R.drawable.ic_info_no_shadow, com.android.launcher3.R.string.app_info_drop_target_label);
        }
