...
public class PopupContainerWithArrow extends AbstractFloatingView implements DragSource,
    ...
    public static PopupContainerWithArrow showForIcon(BubbleTextView icon) {
        ...
        final PopupContainerWithArrow container =
                (PopupContainerWithArrow) launcher.getLayoutInflater().inflate(
                        com.android.launcher3.R.layout.popup_container, launcher.getDragLayer(), false);
    ...
    public void populateAndShow(final BubbleTextView originalIcon, final List<String> shortcutIds,
        ...
        final int arrowWidth = resources.getDimensionPixelSize(com.android.launcher3.R.dimen.popup_arrow_width);
        final int arrowHeight = resources.getDimensionPixelSize(com.android.launcher3.R.dimen.popup_arrow_height);
        final int arrowVerticalOffset = resources.getDimensionPixelSize(
                com.android.launcher3.R.dimen.popup_arrow_vertical_offset);
        ...
        if (numNotifications == 0) {
            ...
            setContentDescription(getContext().getString(
                    com.android.launcher3.R.string.shortcuts_menu_with_notifications_description, numShortcuts,
        ...
        final int arrowHorizontalOffset = resources.getDimensionPixelSize(isAlignedWithStart() ?
                com.android.launcher3.R.dimen.popup_arrow_horizontal_offset_start :
                com.android.launcher3.R.dimen.popup_arrow_horizontal_offset_end);
    ...
    private void addDummyViews(PopupPopulator.Item[] itemTypesToPopulate, int numNotifications) {
        ...
        for (int i = 0; i < numItems; i++) {
            ...
            if (itemTypeToPopulate == PopupPopulator.Item.NOTIFICATION) {
                ...
                int footerHeight = res.getDimensionPixelSize(
                        notificationFooterHasIcons ? com.android.launcher3.R.dimen.notification_footer_height
                                : com.android.launcher3.R.dimen.notification_empty_footer_height);
                item.findViewById(com.android.launcher3.R.id.footer).getLayoutParams().height = footerHeight;
                if (notificationFooterHasIcons) {
                    mNotificationItemView.findViewById(com.android.launcher3.R.id.divider).setVisibility(VISIBLE);
                }
                ...
                if (shouldUnroundTopCorners) {
                    ...
                    mNotificationItemView.findViewById(com.android.launcher3.R.id.gutter_top).setVisibility(VISIBLE);
                }
                if (shouldUnroundBottomCorners) {
                    roundedCorners &= ~ROUNDED_BOTTOM_CORNERS;
                    mNotificationItemView.findViewById(com.android.launcher3.R.id.gutter_bottom).setVisibility(VISIBLE);
                }
                int backgroundColor = Themes.getAttrColor(mLauncher, com.android.launcher3.R.attr.popupColorTertiary);
            ...
            if (itemTypeToPopulate.isShortcut) {
                if (mShortcutsItemView == null) {
                    mShortcutsItemView = (ShortcutsItemView) inflater.inflate(
                            com.android.launcher3.R.layout.shortcuts_item, this, false);
                ...
                if (itemTypeToPopulate != PopupPopulator.Item.SYSTEM_SHORTCUT_ICON
                    ...
                    item.getLayoutParams().height = res.getDimensionPixelSize(
                            com.android.launcher3.R.dimen.bg_popup_item_condensed_height);
        ...
        int backgroundColor = Themes.getAttrColor(mLauncher, com.android.launcher3.R.attr.popupColorPrimary);
        mShortcutsItemView.setBackgroundWithCorners(backgroundColor, shortcutsItemRoundedCorners);
        if (numNotifications > 0) {
            mShortcutsItemView.hideShortcuts(mIsAboveIcon, PopupPopulator.MAX_SHORTCUTS_IF_NOTIFICATIONS);
        }
    }
    ...
    private void animateOpen() {
        ...
        final Resources res = getResources();
        final long revealDuration = (long) res.getInteger(com.android.launcher3.R.integer.config_popupOpenCloseDuration);
        ...
        Animator arrowScale = createArrowScaleAnim(1).setDuration(res.getInteger(
                com.android.launcher3.R.integer.config_popupArrowOpenDuration));
    ...
    private Point computeAnimStartPoint(int itemsTotalHeight) {
        int arrowCenterX = getResources().getDimensionPixelSize(mIsLeftAligned ^ mIsRtl ?
                com.android.launcher3.R.dimen.popup_arrow_horizontal_center_start:
                com.android.launcher3.R.dimen.popup_arrow_horizontal_center_end);
        if (!mIsLeftAligned) {
    ...
    private void orientAboutIcon(BubbleTextView icon, int arrowHeight) {
        ...
        if (isAlignedWithStart()) {
            ...
            int shortcutPaddingStart = resources.getDimensionPixelSize(
                    com.android.launcher3.R.dimen.popup_padding_start);
            ...
            int shortcutPaddingEnd = resources.getDimensionPixelSize(
                    com.android.launcher3.R.dimen.popup_padding_end);
    ...
    private View addArrowView(int horizontalOffset, int verticalOffset, int width, int height) {
        ...
        if (Gravity.isVertical(mGravity)) {
            ...
            arrowPaint.setColor(Themes.getAttrColor(mLauncher, com.android.launcher3.R.attr.popupColorPrimary));
            // The corner path effect won't be reflected in the shadow, but shouldn't be noticeable.
            int radius = getResources().getDimensionPixelSize(com.android.launcher3.R.dimen.popup_arrow_corner_radius);
    ...
    public void trimNotifications(Map<PackageUserKey, BadgeInfo> updatedBadges) {
        ...
        if (badgeInfo == null || badgeInfo.getNotificationKeys().size() == 0) {
            ...
            final int duration = getResources().getInteger(
                    com.android.launcher3.R.integer.config_removeNotificationViewDuration);
