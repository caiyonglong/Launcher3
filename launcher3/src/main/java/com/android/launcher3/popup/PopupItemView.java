...
public abstract class PopupItemView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        mIconView = findViewById(com.android.launcher3.R.id.popup_item_icon);
    }
    ...
    protected float getBackgroundRadius() {
        return getResources().getDimensionPixelSize(com.android.launcher3.R.dimen.bg_round_rect_radius);
    }
}
