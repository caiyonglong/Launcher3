...
public class PopupPopulator {
    ...
    public enum Item {
        SHORTCUT(com.android.launcher3.R.layout.deep_shortcut, true),
        NOTIFICATION(com.android.launcher3.R.layout.notification, false),
        SYSTEM_SHORTCUT(com.android.launcher3.R.layout.system_shortcut, true),
        SYSTEM_SHORTCUT_ICON(com.android.launcher3.R.layout.system_shortcut_icon_only, true);
