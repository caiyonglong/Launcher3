...
public class WorkspaceAccessibilityHelper extends DragAndDropAccessibilityDelegate {
    ...
    protected String getConfirmationForIconDrop(int id) {
        ...
        if (child == null || child == dragInfo.item) {
            ...
            if (info instanceof AppInfo || info instanceof ShortcutInfo) {
                return mContext.getString(com.android.launcher3.R.string.folder_created);

            } else if (info instanceof FolderInfo) {
                return mContext.getString(com.android.launcher3.R.string.added_to_folder);
            }
        }
        return "";
    }
    ...
    public static String getDescriptionForDropOver(View overChild, Context context) {
        ...
        if (info instanceof ShortcutInfo) {
            return context.getString(com.android.launcher3.R.string.create_folder_with, info.title);
        } else if (info instanceof FolderInfo) {
            if (TextUtils.isEmpty(info.title)) {
                ...
                if (firstItem != null) {
                    return context.getString(com.android.launcher3.R.string.add_to_folder_with_app, firstItem.title);
                }
            }
            return context.getString(com.android.launcher3.R.string.add_to_folder, info.title);
        }
        return "";
    }
}
