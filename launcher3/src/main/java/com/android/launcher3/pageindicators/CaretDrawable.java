...
public class CaretDrawable extends Drawable {
    ...
    public CaretDrawable(Context context) {
        ...
        final int strokeWidth = res.getDimensionPixelSize(com.android.launcher3.R.dimen.all_apps_caret_stroke_width);
        final int shadowSpread = res.getDimensionPixelSize(com.android.launcher3.R.dimen.all_apps_caret_shadow_spread);

        mCaretPaint.setColor(Themes.getAttrColor(context, com.android.launcher3.R.attr.workspaceTextColor));
        ...
        mShadowPaint.setColor(res.getColor(com.android.launcher3.R.color.default_shadow_color_no_alpha));
        ...
        mUseShadow = !Themes.getAttrBoolean(context, com.android.launcher3.R.attr.isWorkspaceDarkText);
        mCaretSizePx = res.getDimensionPixelSize(com.android.launcher3.R.dimen.all_apps_caret_size);
    }
