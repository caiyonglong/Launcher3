...
public class AppsSearchContainerLayout extends FrameLayout
    ...
    public AppsSearchContainerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMinHeight = getResources().getDimensionPixelSize(com.android.launcher3.R.dimen.all_apps_search_bar_height);
        mSearchBoxHeight = getResources()
                .getDimensionPixelSize(com.android.launcher3.R.dimen.all_apps_search_bar_field_height);
    ...
    protected void onFinishInflate() {
        ...
        mSearchInput = findViewById(com.android.launcher3.R.id.search_box_input);
        mDivider = findViewById(com.android.launcher3.R.id.search_divider);
