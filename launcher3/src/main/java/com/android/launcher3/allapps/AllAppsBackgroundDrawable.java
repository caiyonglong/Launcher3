...
public class AllAppsBackgroundDrawable extends Drawable {
    ...
    public AllAppsBackgroundDrawable(Context context) {
        ...
        context = new ContextThemeWrapper(context,
                Themes.getAttrBoolean(context, com.android.launcher3.R.attr.isMainColorDark)
                        ? com.android.launcher3.R.style.AllAppsEmptySearchBackground_Dark
                        : com.android.launcher3.R.style.AllAppsEmptySearchBackground);
        mHand = new TransformedImageDrawable(context, com.android.launcher3.R.drawable.ic_all_apps_bg_hand,
                0.575f, 0.f, Gravity.CENTER_HORIZONTAL);
        mIcons = new TransformedImageDrawable[4];
        mIcons[0] = new TransformedImageDrawable(context, com.android.launcher3.R.drawable.ic_all_apps_bg_icon_1,
                0.375f, 0, Gravity.CENTER_HORIZONTAL);
        mIcons[1] = new TransformedImageDrawable(context, com.android.launcher3.R.drawable.ic_all_apps_bg_icon_2,
                0.3125f, 0.2f, Gravity.CENTER_HORIZONTAL);
        mIcons[2] = new TransformedImageDrawable(context, com.android.launcher3.R.drawable.ic_all_apps_bg_icon_3,
                0.475f, 0.26f, Gravity.CENTER_HORIZONTAL);
        mIcons[3] = new TransformedImageDrawable(context, com.android.launcher3.R.drawable.ic_all_apps_bg_icon_4,
