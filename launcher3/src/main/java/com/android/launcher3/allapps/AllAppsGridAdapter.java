...
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
    ...
    public AllAppsGridAdapter(Launcher launcher, AlphabeticalAppsList apps, View.OnClickListener
        ...
        mLauncher = launcher;
        mApps = apps;
        mEmptySearchMessage = res.getString(com.android.launcher3.R.string.all_apps_loading_message);
    ...
    public void setLastSearchQuery(String query) {
        ...
        mEmptySearchMessage = res.getString(com.android.launcher3.R.string.all_apps_no_search_results, query);
        ...
        switch (viewType) {
            ...
            case VIEW_TYPE_PREDICTION_ICON:
                BubbleTextView icon = (BubbleTextView) mLayoutInflater.inflate(
                        com.android.launcher3.R.layout.all_apps_icon, parent, false);
            ...
            case VIEW_TYPE_DISCOVERY_ITEM:
                AppDiscoveryItemView appDiscoveryItemView = (AppDiscoveryItemView) mLayoutInflater
                        .inflate(com.android.launcher3.R.layout.all_apps_discovery_item, parent, false);
            ...
            case VIEW_TYPE_EMPTY_SEARCH:
                return new ViewHolder(mLayoutInflater.inflate(com.android.launcher3.R.layout.all_apps_empty_search,
                        parent, false));
            case VIEW_TYPE_SEARCH_MARKET:
                View searchMarketView = mLayoutInflater.inflate(com.android.launcher3.R.layout.all_apps_search_market,
                        parent, false);
            ...
            case VIEW_TYPE_APPS_LOADING_DIVIDER:
                View loadingDividerView = mLayoutInflater.inflate(
                        com.android.launcher3.R.layout.all_apps_discovery_loading_divider, parent, false);
                return new ViewHolder(loadingDividerView);
            case VIEW_TYPE_PREDICTION_DIVIDER:
            case VIEW_TYPE_SEARCH_MARKET_DIVIDER:
                return new ViewHolder(mLayoutInflater.inflate(
                        com.android.launcher3.R.layout.all_apps_divider, parent, false));
            default:
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            ...
            case VIEW_TYPE_APPS_LOADING_DIVIDER:
                ...
                holder.itemView.findViewById(com.android.launcher3.R.id.loadingProgressBar).setVisibility(visLoading);
                holder.itemView.findViewById(com.android.launcher3.R.id.loadedDivider).setVisibility(visLoaded);
                break;
            case VIEW_TYPE_SEARCH_MARKET_DIVIDER:
                // nothing to do
                break;
