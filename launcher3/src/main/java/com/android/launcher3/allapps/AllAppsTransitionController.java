...
public class AllAppsTransitionController implements TouchController, SwipeDetector.Listener,
    ...
    public AllAppsTransitionController(Launcher l) {
        ...
        mIsDarkTheme = Themes.getAttrBoolean(mLauncher, com.android.launcher3.R.attr.isMainColorDark);
    }
    ...
    private void updateAllAppsBg(float progress) {
        ...
        if (mGradientView == null) {
            mGradientView = (GradientView) mLauncher.findViewById(com.android.launcher3.R.id.gradient_bg);
    ...
    public void showDiscoveryBounce() {
        ...
        mDiscoBounceAnimation = AnimatorInflater.loadAnimator(mLauncher,
                com.android.launcher3.R.animator.discovery_bounce);
