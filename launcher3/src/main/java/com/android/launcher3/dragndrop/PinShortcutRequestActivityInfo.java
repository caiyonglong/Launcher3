...
class PinShortcutRequestActivityInfo extends ShortcutConfigActivityInfo {
    ...
    public com.android.launcher3.ShortcutInfo createShortcutInfo() {
        ...
        long duration = mContext.getResources().getInteger(com.android.launcher3.R.integer.config_dropAnimMaxDuration) +
                Launcher.EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT +
                mContext.getResources().getInteger(com.android.launcher3.R.integer.config_overlayTransitionTime) / 2;
