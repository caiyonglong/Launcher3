...
public class DragView extends View {
    ...
    public DragView(Launcher launcher, Bitmap bitmap, int registrationX, int registrationY,
        ...
        mBlurSizeOutline = getResources().getDimensionPixelSize(com.android.launcher3.R.dimen.blur_size_medium_outline);
            ...
            public void run() {
                ...
                if (dr instanceof AdaptiveIconDrawable) {
                    ...
                    int blurMargin = (int) mLauncher.getResources()
                            .getDimension(com.android.launcher3.R.dimen.blur_size_medium_outline) / 2;
    ...
    private Drawable getBadge(ItemInfo info, LauncherAppState appState, Object obj) {
        ...
        if (info.itemType == LauncherSettings.Favorites.ITEM_TYPE_DEEP_SHORTCUT) {
            ...
            float badgeSize = mLauncher.getResources().getDimension(com.android.launcher3.R.dimen.profile_badge_size);
