...
public class FlingToDeleteHelper {
    ...
    public FlingToDeleteHelper(Launcher launcher) {
        ...
        mFlingToDeleteThresholdVelocity = launcher.getResources()
                .getDimensionPixelSize(com.android.launcher3.R.dimen.drag_flingToDeleteMinVelocity);
    }
    ...
    private PointF isFlingingToDelete() {
        if (mDropTarget == null) {
            mDropTarget = (ButtonDropTarget) mLauncher.findViewById(com.android.launcher3.R.id.delete_target_text);
        }
