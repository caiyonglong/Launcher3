...
public class AddItemActivity extends BaseActivity implements OnLongClickListener, OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.android.launcher3.R.layout.add_item_confirmation_activity);
        mWidgetCell = findViewById(com.android.launcher3.R.id.widget_cell);
    ...
    public boolean onLongClick(View view) {
        ...
        if (!getResources().getBoolean(com.android.launcher3.R.bool.allow_rotation) &&
