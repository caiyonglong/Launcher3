...
public class ShortcutsItemView extends PopupItemView implements View.OnLongClickListener,
    ...
    protected void onFinishInflate() {
        ...
        mContent = findViewById(com.android.launcher3.R.id.content);
        mShortcutsLayout = findViewById(com.android.launcher3.R.id.shortcuts);
    }
        ...
        if (shortcutType == PopupPopulator.Item.SYSTEM_SHORTCUT_ICON) {
            ...
            if (mSystemShortcutIcons == null) {
                mSystemShortcutIcons = (LinearLayout) mLauncher.getLayoutInflater().inflate(
                        com.android.launcher3.R.layout.system_shortcut_icons, mContent, false);
            ...
            if (mShortcutsLayout.getChildCount() > 0) {
                ...
                if (prevChild instanceof DeepShortcutView) {
                    prevChild.findViewById(com.android.launcher3.R.id.divider).setVisibility(VISIBLE);
                }
            }
    ...
    public void hideShortcuts(boolean hideFromTop, int maxShortcuts) {
        ...
        final int newHeight = getResources().getDimensionPixelSize(com.android.launcher3.R.dimen.bg_popup_item_height);
        ...
        for (int i = hideFromTop ? 0 : numShortcuts - 1; 0 <= i && i < numShortcuts; i += dir) {
            ...
            if (child instanceof DeepShortcutView) {
                ...
                if (!hideFromTop && 0 <= prev && prev < numShortcuts) {
                    ...
                    mShortcutsLayout.getChildAt(prev).findViewById(com.android.launcher3.R.id.divider).setVisibility(GONE);
                }
                numToHide--;
                if (numToHide == 0) {
                    break;
    ...
    public Animator showAllShortcuts(boolean showFromTop) {
        ...
        for (int i = 0; i < numShortcuts; i++) {
            ...
            if (i < numShortcuts - 1) {
                view.findViewById(com.android.launcher3.R.id.divider).setVisibility(VISIBLE);
            }
        }
