...
public class LauncherIcons {
        ...
        if (!FeatureFlags.LAUNCHER3_DISABLE_ICON_NORMALIZATION) {
            ...
            if (Utilities.ATLEAST_OREO && iconAppTargetSdk >= Build.VERSION_CODES.O) {
                ...
                AdaptiveIconDrawable dr = (AdaptiveIconDrawable)
                        context.getDrawable(com.android.launcher3.R.drawable.adaptive_icon_drawable_wrapper).mutate();
    ...
    public static Bitmap badgeWithDrawable(Bitmap srcTgt, Drawable badge, Context context) {
        int badgeSize = context.getResources().getDimensionPixelSize(com.android.launcher3.R.dimen.profile_badge_size);
