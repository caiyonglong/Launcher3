...
public class ShadowDrawable extends Drawable {
    ...
    public void applyTheme(Resources.Theme t) {
        TypedArray ta = t.obtainStyledAttributes(new int[] {com.android.launcher3.R.attr.isWorkspaceDarkText});
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs,
        ...
        final TypedArray a = theme == null
                ? r.obtainAttributes(attrs, com.android.launcher3.R.styleable.ShadowDrawable)
                : theme.obtainStyledAttributes(attrs, com.android.launcher3.R.styleable.ShadowDrawable, 0, 0);
        try {
            Drawable d = a.getDrawable(com.android.launcher3.R.styleable.ShadowDrawable_android_src);
            if (d == null) {
                throw new XmlPullParserException("missing src attribute");
            }
            mState.mShadowColor = a.getColor(
                    com.android.launcher3.R.styleable.ShadowDrawable_android_shadowColor, Color.BLACK);
            mState.mShadowSize = a.getDimensionPixelSize(
                    com.android.launcher3.R.styleable.ShadowDrawable_android_elevation, 0);
            mState.mDarkTintColor = a.getColor(
                    com.android.launcher3.R.styleable.ShadowDrawable_darkTintColor, Color.BLACK);
