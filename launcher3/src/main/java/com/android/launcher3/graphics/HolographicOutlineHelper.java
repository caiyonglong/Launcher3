...
public class HolographicOutlineHelper {
    ...
    private HolographicOutlineHelper(Context context) {
        ...
        float mediumBlur = res.getDimension(com.android.launcher3.R.dimen.blur_size_medium_outline);
        ...
        mThinOuterBlurMaskFilter = new BlurMaskFilter(
                res.getDimension(com.android.launcher3.R.dimen.blur_size_thin_outline), BlurMaskFilter.Blur.OUTER);

        mShadowBitmapShift = res.getDimension(com.android.launcher3.R.dimen.blur_size_click_shadow);
