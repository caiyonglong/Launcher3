    ...
    public static class ShadowInfo {
        ...
        public ShadowInfo(Context c, AttributeSet attrs, int defStyle) {
            ...
            TypedArray a = c.obtainStyledAttributes(
                    attrs, com.android.launcher3.R.styleable.ShadowInfo, defStyle, 0);

            ambientShadowBlur = a.getDimension(com.android.launcher3.R.styleable.ShadowInfo_ambientShadowBlur, 0);
            ambientShadowColor = a.getColor(com.android.launcher3.R.styleable.ShadowInfo_ambientShadowColor, 0);

            keyShadowBlur = a.getDimension(com.android.launcher3.R.styleable.ShadowInfo_keyShadowBlur, 0);
            keyShadowOffset = a.getDimension(com.android.launcher3.R.styleable.ShadowInfo_keyShadowOffset, 0);
            keyShadowColor = a.getColor(com.android.launcher3.R.styleable.ShadowInfo_keyShadowColor, 0);
            a.recycle();
        }
