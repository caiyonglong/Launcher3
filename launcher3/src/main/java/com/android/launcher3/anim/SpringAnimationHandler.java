...
public class SpringAnimationHandler<T> {
    ...
    public void add(View view, T object) {
        SpringAnimation spring = (SpringAnimation) view.getTag(com.android.launcher3.R.id.spring_animation_tag);
        if (spring == null) {
            spring = mAnimationFactory.initialize(object);
            view.setTag(com.android.launcher3.R.id.spring_animation_tag, spring);
        }
    ...
    public void remove(View view) {
        remove((SpringAnimation) view.getTag(com.android.launcher3.R.id.spring_animation_tag));
    }
