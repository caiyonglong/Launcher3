...
public class PreviewImageView extends ImageView {
    ...
    public static PreviewImageView get(Context context) {
        ...
        PreviewImageView view = (PreviewImageView) dragLayer.getTag(com.android.launcher3.R.id.preview_image_id);
        if (view == null) {
            view = new PreviewImageView(dragLayer);
            dragLayer.setTag(com.android.launcher3.R.id.preview_image_id, view);
        }
        return view;
    }
}
