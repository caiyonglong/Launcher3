...
public abstract class PopupItemView extends FrameLayout {
    ...
    protected  @PopupContainerWithArrow.RoundedCornerFlags
    int mRoundedCorners;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if ((mRoundedCorners & PopupContainerWithArrow.ROUNDED_TOP_CORNERS) != 0) {
        ...
        if ((mRoundedCorners & PopupContainerWithArrow.ROUNDED_BOTTOM_CORNERS) != 0) {
     ...
     */
    public void setBackgroundWithCorners(int color, @PopupContainerWithArrow.RoundedCornerFlags int roundedCorners) {
        mRoundedCorners = roundedCorners;
        float rTop = (roundedCorners & PopupContainerWithArrow.ROUNDED_TOP_CORNERS) == 0 ? 0 : getBackgroundRadius();
        float rBot = (roundedCorners & PopupContainerWithArrow.ROUNDED_BOTTOM_CORNERS) == 0 ? 0 : getBackgroundRadius();
