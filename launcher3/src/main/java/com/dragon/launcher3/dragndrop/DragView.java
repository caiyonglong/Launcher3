...
import com.dragon.launcher3.FastBitmapDrawable;
...
import com.dragon.launcher3.compat.ShortcutConfigActivityInfo;
import com.dragon.launcher3.config.FeatureFlags;
import com.dragon.launcher3.graphics.IconNormalizer;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawBitmap) {
            ...
            if (crossFade) {
                ...
                @SuppressLint("WrongConstant") final int saveCount = canvas.save(Canvas.MATRIX_SAVE_FLAG);
