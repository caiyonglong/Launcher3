...
import com.dragon.launcher3.MainThreadExecutor;
import com.dragon.launcher3.PagedView;
...
public class LoaderResults {
    ...
    public LoaderResults(LauncherAppState app, BgDataModel dataModel,
            AllAppsList allAppsList, int pageToBindFirst, WeakReference<LauncherModel.Callbacks> callbacks) {
        mUiExecutor = new MainThreadExecutor();
        mApp = app;
        mBgDataModel = dataModel;
        mBgAllAppsList = allAppsList;
        mPageToBindFirst = pageToBindFirst;
        mCallbacks = callbacks == null ? new WeakReference<LauncherModel.Callbacks>(null) : callbacks;
    }
