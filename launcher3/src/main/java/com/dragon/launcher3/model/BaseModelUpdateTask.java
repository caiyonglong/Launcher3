...
/**
 * Extension of {@link LauncherModel.ModelUpdateTask} with some utility methods
 */
public abstract class BaseModelUpdateTask implements LauncherModel.ModelUpdateTask {
    ...
    public final void scheduleCallbackTask(final LauncherModel.CallbackTask task) {
        final LauncherModel.Callbacks callbacks = mModel.getCallback();
        mUiExecutor.execute(new Runnable() {
            public void run() {
                LauncherModel.Callbacks cb = mModel.getCallback();
