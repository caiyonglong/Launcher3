...
import com.dragon.launcher3.util.GridOccupancy;
...
public class AddWorkspaceItemsTask extends BaseModelUpdateTask {
    ...
    public void execute(LauncherAppState app, BgDataModel dataModel, AllAppsList apps) {
        ...
        ArrayMap<UserHandle, ManagedProfileHeuristic.UserFolderInfo> userFolderMap = new ArrayMap<>();
            ...
            for (Pair<ItemInfo, Object> entry : workspaceApps) {
                ...
                if (item.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION) {
                    ...
                    if (!Process.myUserHandle().equals(item.user)) {
                        ...
                        ManagedProfileHeuristic.UserFolderInfo userFolderInfo = userFolderMap.get(item.user);
                        if (userFolderInfo == null) {
                            userFolderInfo = new ManagedProfileHeuristic.UserFolderInfo(context, item.user, dataModel);
        ...
        for (ManagedProfileHeuristic.UserFolderInfo userFolderInfo : userFolderMap.values()) {
