...
public class WallpaperManagerCompatVL extends WallpaperManagerCompat {
    ...
    private static final String ACTION_EXTRACTION_COMPLETE =
            "WallpaperManagerCompatVL.EXTRACTION_COMPLETE";
    ...
    WallpaperManagerCompatVL(Context context) {
        ...
        String colors = Utilities.getDevicePrefs(mContext).getString(KEY_COLORS, "");
        int wallpaperId = -1;
    ...
    private void handleResult(String result) {
        Utilities.getDevicePrefs(mContext).edit().putString(KEY_COLORS, result).apply();
